        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
                ...
                <div class="container">
                        ...
                        <div class="slide-inner">
                            ...
                            <ul class="slide-area">
                                ...
                                <li class="px-3">
                                    ...
                                    <p class="small"><?php echo substr($value["descripcion_articulo"],0,-110)."..." ;?>
                                    </p>
                    ...
                    <img src="<?php echo $blog["dominio"]; ?>vistas/img/ad01.jpg"
                    ...
                    <div class="d-flex my-3">
                        ...
                        <div class="w-100 w-xl-50 pr-3 pt-2">
                            ...
                            <a href="articulos.html">
                                ...
                                <img src="<?php echo $blog["dominio"]; ?>vistas/img/articulo05.png"
                                    alt="Lorem ipsum dolor sit amet" class="img-fluid">
                    ...
                    <div class="d-flex my-3">
                        ...
                        <div class="w-100 w-xl-50 pr-3 pt-2">
                            ...
                            <a href="articulos.html">
                                ...
                                <img src="<?php echo $blog["dominio"]; ?>vistas/img/articulo06.png"
                                    alt="Lorem ipsum dolor sit amet" class="img-fluid">
                    ...
                    <div class="d-flex my-3">
                        ...
                        <div class="w-100 w-xl-50 pr-3 pt-2">
                            ...
                            <a href="articulos.html">
                                ...
                                <img src="<?php echo $blog["dominio"]; ?>vistas/img/articulo07.png"
                                    alt="Lorem ipsum dolor sit amet" class="img-fluid">
