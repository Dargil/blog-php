...
@section('content')
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <button class="btn btn-primary btn-sm" data-toggle="modal"
                                    data-target="#crearArticulo">Crear nuevo artículo</button>
              ...
              @foreach ($articulos as $key => $value)
                ...
                @endforeach
                                ...
                                <table class="table table-bordered table-striped dt-responsive" id="tablaArticulos"
                                    width="100%">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="titulo_articulo"
                                placeholder="Ingrese el titulo del artículo" value="{{ old('titulo_articulo') }}" required>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="descripcion_articulo"
                                placeholder="Ingrese la descripción del artículo" value="{{ old('descripcion_articulo') }}"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control inputRuta" name="ruta_articulo"
                                placeholder="Ingrese la ruta del artículo" value="{{ old('ruta_articulo') }}" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" value="artículo" name="p_claves_articulo"
                ...
                <div class="modal" id="editarArticulo">
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/') }}/articulos/{{ $value->id_articulo }}" method="post"
                                ...
                                <div class="modal-body">
                                        ...
                                        <select class="form-control" name="id_cat" required>
                                            ...
                                            @foreach ($categorias as $key => $value2)
                                                ...
                                                @if ($value2->id_categoria == $value->id_cat)
                                                    <option value="{{ $value->id_cat }}">{{ $value2->titulo_categoria }}
                                                    </option>
                                                @endif
                                            ...
                                            @foreach ($categorias as $key => $value2)
                                                ...
                                                @if ($value2->id_categoria != $value->id_cat)
                                                    ...
                                                    <option value="{{ $value2->id_categoria }}">
                                                        {{ $value2->titulo_categoria }}</option>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="titulo_articulo"
                                            ...
                                            value="{{ $value->titulo_articulo }}" required>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="descripcion_articulo"
                                            ...
                                            value="{{ $value->descripcion_articulo }}" maxlength="220" required>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control inputRuta" name="ruta_articulo"
                                            placeholder="Ingrese la ruta del artículo" value="{{ $value->ruta_articulo }}"
                                            readonly>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="p_claves_articulo"
                                            data-role="tagsinput" value="{{ $p_claves }}" required>
                                    ...
                                    <div class="form-group my-2 text-center">
                                        ...
                                        <img src="{{ url('/') }}/{{ $value->portada_articulo }}"
                                            class="previsualizarImg_img_articulo img-fluid py-2">

                                        <input type="hidden" value="{{ $value->portada_articulo }}" name="imagen_actual">

                                        <p class="help-block small">Dimensiones: 680px * 400px | Peso Max. 2MB | Formato:
                                            JPG o PNG</p>
                                    ...
                                    <textarea name="contenido_articulo" class="form-control summernote-editar-articulo"
                                        required>{{ $value->contenido_articulo }}</textarea>
    ...
    @if (Session::has('error'))
        ...
        <script>
            notie.alert({
                type: 3,
                text: '¡Error en el gestor de artículos!',
                time: 10
            })
        </script>
