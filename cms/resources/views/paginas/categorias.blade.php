                ...
                <div class="modal" id="editarCategoria">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/') }}/categorias/{{ $value->id_categoria }}" method="post"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="titulo_categoria"
                                            ...
                                            value="{{ $value->titulo_categoria }}" required>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="descripcion_categoria"
                                            placeholder="Ingrese la descripción de la categoría"
                                            value="{{ $value->descripcion_categoria }}" maxlength="30" required>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control inputRuta" name="ruta_categoria"
                                            placeholder="Ingrese la ruta de la categoría"
                                            value="{{ $value->ruta_categoria }}" required>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $p_claves_categoria }}"
                                            name="p_claves_categoria" data-role="tagsinput" required>
                                    ...
                                    <div class="form-group my-2 text-center">
                                        ...
                                        <img src="{{ url('/') }}/{{ $value->img_categoria }}"
                                            class="previsualizarImg_img_categoria img-fluid py-2">

                                        <input type="hidden" value="{{ $value->img_categoria }}" name="imagen_actual">

                                        <p class="help-block small">Dimensiones: 1024px * 250px | Peso Max. 2MB | Formato:
                                            JPG o PNG</p>
                                    </div>
